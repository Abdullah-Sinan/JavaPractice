...
public class MoreStringPractice {
	...
	public static void main(String[] args) {
		...
		String s1 = "Zuhkra" ;
		boolean uExistsOfNot = s1.contains("u")  ;
		...
		//it will return part of a string staring from begininng till right before ending index
		...
		String s2 = "SAYYARRA" ;
		String partOfStringf = s2.substring(3, 6);
		System.out.println( partOfStringf );
